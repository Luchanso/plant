...
nnoremap  :wa | :mksession! session.vim
...
nnoremap <C-S> :wa | :mksession! session.vim
...
set completeopt=menuone,menu,menuone,noinsert
...
set ignorecase
set incsearch
set langmap=йЙцЦуУкКеЕнНгГшШщЩзЗхХъЪфФыЫвВаАпП��РоОлЛдДжЖэЭяЯчЧсСмМиИтТьЬбБюЮ.\\,;qQwWeErRtTyYuUiIoOpP[{]}aAsSdDfFgGhHjJkKlL;:'\"zZxXcCvVbBnNmM\\,<.>/?
set laststatus=2
set omnifunc=syntaxcomplete#Complete
set ruler
set runtimepath=~/.vim,~/.vim/userplugins/vim-smoothie,~/.vim/userplugins/vim-clang-format,~/.vim/userplugins/vim-lsc,~/.vim/userplugins/vim-cmake,~/.vim/userplugins/fern.vim,~/.vim/userplugins/fern-hijack.vim,~/.vim/userplugins/vim-airline,~/.vim/userplugins/vim-airline-themes,~/.vim/userplugins/supertab,/usr/share/vim/vimfiles,/usr/share/vim/vim90,/usr/share/vim/vimfiles/after,~/.vim/userplugins/vim-lsc/after,~/.vim/after
set shiftwidth=2
set showcmd
set showmatch
set smartcase
...
badd +15 ~/prog/vulkantest/CMakeLists.txt
badd +1 ~/prog/vulkantest/src/CMakeLists.txt
badd +3 src/CMakeLists.txt
badd +3 src/bme280.c
badd +22 test.c
badd +379 cmake/avr-gcc-toolchain.cmake
badd +0 src/main.c
badd +0 src/timers.h
badd +0 src/pinio.h
argglobal
...
argglobal
nnoremap <buffer>  :LSClientNextReference
nnoremap <buffer>  :LSClientPreviousReference
nnoremap <buffer>  :LSClientGoToDefinitionSplit
nnoremap <buffer> ] :LSClientGoToDefinitionSplit
nnoremap <buffer> gR :LSClientRename
nnoremap <buffer> gm :LSClientSignatureHelp
nnoremap <buffer> gS :LSClientWorkspaceSymbol
nnoremap <buffer> go :LSClientDocumentSymbol
nnoremap <buffer> ga :LSClientFindCodeActions
nnoremap <buffer> gI :LSClientFindImplementations
nnoremap <buffer> gr :LSClientFindReferences
nnoremap <buffer> gd :LSClientGoToDefinition
let s:cpo_save=&cpo
set cpo&vim
nnoremap <buffer> <C-P> :LSClientPreviousReference
nnoremap <buffer> <C-N> :LSClientNextReference
nnoremap <buffer> <C-W><C-]> :LSClientGoToDefinitionSplit
nnoremap <buffer> <C-W>] :LSClientGoToDefinitionSplit
let &cpo=s:cpo_save
unlet s:cpo_save
setlocal keymap=
setlocal noarabic
...
keepjumps 17
normal! 0
lcd ~/prog/plant/hardware
wincmd w
argglobal
if bufexists(fnamemodify("~/prog/plant/hardware/src/CMakeLists.txt", ":p")) | buffer ~/prog/plant/hardware/src/CMakeLists.txt | else | edit ~/prog/plant/hardware/src/CMakeLists.txt | endif
nnoremap <buffer>  :LSClientNextReference
nnoremap <buffer>  :LSClientPreviousReference
nnoremap <buffer>  :LSClientGoToDefinitionSplit
nnoremap <buffer> ] :LSClientGoToDefinitionSplit
...
exe 'vert 2resize ' . ((&columns * 84 + 84) / 169)
tabnext
edit ~/prog/plant/hardware/src/main.c
argglobal
nnoremap <buffer>  :LSClientNextReference
nnoremap <buffer>  :LSClientPreviousReference
nnoremap <buffer>  :LSClientGoToDefinitionSplit
...
lcd ~/prog/plant/hardware
tabnext
edit ~/prog/plant/hardware/src/pinio.h
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
lcd ~/prog/plant/hardware
tabnext
edit ~/prog/plant/hardware/src/timers.h
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
wincmd w
argglobal
if bufexists(fnamemodify("~/prog/plant/hardware/src/timers.h", ":p")) | buffer ~/prog/plant/hardware/src/timers.h | else | edit ~/prog/plant/hardware/src/timers.h | endif
nnoremap <buffer>  :LSClientNextReference
nnoremap <buffer>  :LSClientPreviousReference
nnoremap <buffer>  :LSClientGoToDefinitionSplit
nnoremap <buffer> ] :LSClientGoToDefinitionSplit
